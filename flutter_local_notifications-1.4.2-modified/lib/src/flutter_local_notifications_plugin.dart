...
class FlutterLocalNotificationsPlugin {
  ...
  Future<void> showWeeklyAtDayAndTime(int id, String title, String body,
      Day day, Time notificationTime, RepeatInterval interval, NotificationDetails notificationDetails,
      {String payload}) async {
    ///MODIFIED///
    if (_platform.isAndroid) {
      await resolvePlatformSpecificImplementation<
              AndroidFlutterLocalNotificationsPlugin>()
          ?.showWeeklyAtDayAndTime(id, title, body, day, notificationTime, interval,
      ...
      await resolvePlatformSpecificImplementation<
          ...
          ?.showWeeklyAtDayAndTime(
              id, title, body, day, notificationTime, interval, notificationDetails?.iOS,
              payload: payload);
    }
  }
